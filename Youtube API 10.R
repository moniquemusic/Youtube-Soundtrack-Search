...
for(gg_g in gg_games){
  ...
  while(n<= 5){
    ...
    c <- c +1
    if(c == length(sorted_segments){
      #if(n == 1){
      #best_segments_2<- c(best_segments_2, NA, NA, NA, NA, NA)
      #}
      #if(n == 2){
      #best_segments_2<- c(best_segments_2, NA, NA, NA, NA)
      #}
      #if(n == 3){
      #best_segments_2<- c(best_segments_2, NA, NA, NA)
      #}
      #if(n == 4){
      #best_segments_2<- c(best_segments_2, NA, NA)
      #}
    }
...
best_segments_3_list <- as.list(best_segments_3)
...
for(gg_g in gg_games){
  ...
  used_key_terms <- best_segments_3[which_key_term]
